...
function addCollisionClasses(world)
    world:addCollisionClass(fireConfig.collisionClass)
    world:addCollisionClass(iceConfig.collisionClass, {ignores = {fireConfig.collisionClass}})
    world:addCollisionClass('FireBullet', {ignores = {iceConfig.collisionClass}})
    world:addCollisionClass('IceBullet', {ignores = {fireConfig.collisionClass}})
    world:addCollisionClass('EnergyField', {ignores = {fireConfig.collisionClass, iceConfig.collisionClass}})
end